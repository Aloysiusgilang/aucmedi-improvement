...
#-----------------------------------------------------#
class GaussianBlur(Subfunction_Base):
    ...
    def __init__(self, blur_limit=7):
        ...
        params = {"p":1.0, "always_apply":True, "blur_limit":blur_limit, "sigma_limit":(0.0, 0.0)}
        # Initialize Blur transform
        self.aug_transform = albumentations.GaussianBlur(**params)
