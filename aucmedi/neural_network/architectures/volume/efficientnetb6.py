...
#                    Documentation                    #
#-----------------------------------------------------#
""" The classification variant of the ResNet18 architecture.

| Architecture Variable    | Value                      |
| ------------------------ | -------------------------- |
| Key in architecture_dict | "3D.ResNet18"              |
...
#-----------------------------------------------------#
class EfficientNetB6(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model(self):
        ...
        BaseModel, preprocess_input = Classifiers.get("efficientnetb6")
